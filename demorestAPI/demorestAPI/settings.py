"""
Django settings for demorestAPI project.
...
MIDDLEWARE = [
    ...
    'apibackendapp.middleware.demo_middleware',
    'apibackendapp.middleware.APILogMiddleware',
]

ROOT_URLCONF = 'demorestAPI.urls'
...
WSGI_APPLICATION = 'demorestAPI.wsgi.application'
